...
function getBaseUri(server, config) {
  ...
  if (config.environment === exports.Environment.Custom) {
    if (server === 'default') {
      return core.pathTemplate(_templateObject$t(), new core.SkipEncode(config.customUrl));
    }
  }
...
function createRequestHandlerFactory(baseUrlProvider, authProvider, httpClient, addons, xmlSerializer) {
  var requestBuilderFactory = core.createRequestBuilderFactory(createHttpClientAdapter(httpClient), baseUrlProvider, ApiError, authProvider, xmlSerializer);
