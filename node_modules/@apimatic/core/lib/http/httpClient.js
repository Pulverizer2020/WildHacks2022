...
exports.HttpClient = exports.DEFAULT_TIMEOUT = exports.DEFAULT_AXIOS_CONFIG_OVERRIDES = void 0;
...
var abortError_1 = require("../errors/abortError");
...
var HttpClient = /** @class */ (function () {
    ...
    HttpClient.prototype.convertHttpRequest = function (req) {
        ...
        if ((requestBody === null || requestBody === void 0 ? void 0 : requestBody.type) === 'text') {
            ...
            requestBody.content.some(function (item) { return fileWrapper_1.isFileWrapper(item.value); })) {
            ...
            try {
                for (var _d = tslib_1.__values(requestBody.content), _e = _d.next(); !_e.done; _e = _d.next()) {
                    var iter = _e.value;
                    if (fileWrapper_1.isFileWrapper(iter.value)) {
                        var fileData = iter.value.file;
                        // Make sure Blob has the correct content type if provided
                        if (apiHelper_1.isBlob(fileData) && ((_b = iter.value.options) === null || _b === void 0 ? void 0 : _b.contentType)) {
            ...
            httpHeaders_1.mergeHeaders(newRequest.headers, form.getHeaders());
        }
        else if ((requestBody === null || requestBody === void 0 ? void 0 : requestBody.type) === 'form-data' ||
            (requestBody === null || requestBody === void 0 ? void 0 : requestBody.type) === 'form') {
            // Create form-urlencoded request
            httpHeaders_1.setHeader(newRequest.headers, httpHeaders_1.CONTENT_TYPE_HEADER, httpHeaders_1.FORM_URLENCODED_CONTENT_TYPE);
            newRequest.data = queryString_1.urlEncodeKeyValuePairs(requestBody.content);
        }
        else if ((requestBody === null || requestBody === void 0 ? void 0 : requestBody.type) === 'stream') {
            var contentType = 'application/octet-stream';
            if (apiHelper_1.isBlob(requestBody.content.file) && requestBody.content.file.type) {
            ...
            httpHeaders_1.setHeaderIfNotSet(newRequest.headers, httpHeaders_1.CONTENT_TYPE_HEADER, contentType);
    ...
    HttpClient.prototype.abortError = function () {
        return new abortError_1.AbortError('The HTTP call was aborted.');
    };
    return HttpClient;
}());
